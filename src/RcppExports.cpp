...
// partial_jsd
DataFrame partial_jsd(DataFrame text, CharacterVector group_list, CharacterVector word_list, String group, String word, String n);
RcppExport SEXP _dhmeasures_partial_jsd(SEXP textSEXP, SEXP group_listSEXP, SEXP word_listSEXP, SEXP groupSEXP, SEXP wordSEXP, SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< DataFrame >::type text(textSEXP);
    ...
    Rcpp::traits::input_parameter< String >::type word(wordSEXP);
    Rcpp::traits::input_parameter< String >::type n(nSEXP);
    rcpp_result_gen = Rcpp::wrap(partial_jsd(text, group_list, word_list, group, word, n));
    return rcpp_result_gen;
END_RCPP
}
// log_likelihood
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_dhmeasures_partial_jsd", (DL_FUNC) &_dhmeasures_partial_jsd, 6},
